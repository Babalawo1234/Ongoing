    ...
    <div>
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Academic Advisor Profile</h1>
            <p className="mt-2 text-gray-600 dark:text-gray-400">Manage your advisor account</p>
          </div>
          {!isEditing ? (
            <button
              onClick={handleEdit}
      ...
      {/* Profile Header */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8 border border-gray-200 dark:border-gray-700 mb-6">
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-1">{user.email}</p>
            <span className="inline-flex items-center px-4 py-2 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-400 rounded-full text-sm font-semibold">
        ...
        <div className="p-6">
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-lg font-medium text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-700/50 px-4 py-3 rounded-lg font-mono">
                {user.id}
              </p>
            </div>
          </div>
